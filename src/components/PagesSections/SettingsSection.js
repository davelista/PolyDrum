            ...
            <div className={styles.container}>
                ...
                <div className={styles.rhythmButtons}>
                    {appData.rhythmsList.item.map((x) => {
                        return <Button buttonStyle='btn--secondary' onClick={() => appData.selectedRhythm.setNumber(x)}>{x}</Button>
                    })}
                    <Button buttonStyle='btn--secondary' onClick={() => appData.rhythmsList.setItem(appData.rhythmsList.item.concat(appData.rhythmsList.item.length))}> + </Button>
                </div>
                {/*FINE*/}
                <Dropdown/>
